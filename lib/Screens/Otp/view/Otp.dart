...
class _OtpsState extends State<Otps> {
  ...
  String phone = Get.routerDelegate?.currentConfiguration.printInfo('phone');
                      ...
                      child: Padding(
                        ...
                        child: PinFieldAutoFill(
                          ...
                          onCodeChanged: (code) async {
                            otpController
                                .setOtpLen(code?.length.toString().obs);
                              ...
                              if (controller.text.length == 4) {
                                await instance.verifyPhoneNumber(
                                  ...
                                  verificationCompleted:
                                    ...
                                    print(
                                        'phonecredential${credential.smsCode}');
                                  },
                                  verificationFailed:
                                  ...
                                  codeAutoRetrievalTimeout:
                                    ...
                                    print('auto reterival $verificationId');
                                  },
                                );

...
class _SignUpState extends State<SignUp> {
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Padding(
            ...
            child: Material(
              child: InkWell(
                onTap: () async {
                  if (c.isReadyToLogin == 'true') {
                    String id = textEditingControllerName.text
                            .substring(0, 4)
                            .toLowerCase() +
                        textEditingControllerNumber.text.substring(0, 4);
                    ...
                    await FirebaseFirestore.instance
                        ...
                        .set({
                      'id': id,
                      'phone': textEditingControllerNumber.text,
                ...
                child: GetBuilder<Controllersr>(
                    init: Controllersr(),
                    didUpdateWidget: (get, state) {
                      if (get.isBlank == false) {
                        state.getUpdate();
                      }
                    },
                    builder: (_t) {
                      ...
                      // is _t.isReadyToLogin

                      isvisible = c.isReadyToLogin.value;
  ...
  allTextFieldValidation(
    ...
    if (txEdone.value.text.length <= 9 ||
      ...
      e.update();
    } else if (txEdtwo.value.text.length <= 4) {
